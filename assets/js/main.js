(function ($) {
  ...
  */
  ...
  $(window).resize(function(){
    ...
    var scwith = $(window).width();

    if(scwith > 810){
      $("#site-bar").addClass("st-sticky-header");
      $("#pleft").addClass("st-nav");
    }
    else{
      $("#site-bar").removeClass("st-sticky-header");
      $("#pleft").removeClass("st-nav");
    }
 ...
 /*--------------------------------------------------------------
  ...
  function onePageNavigation() {
    ...
    $('.sidet-smooth-move').on('click', function () {
      var thisAttr = $(this).attr('href');
      if ($(thisAttr).length) {
        var scrollPoint = $(thisAttr).offset().top - 100;
        $('body,html').animate({
          scrollTop: scrollPoint
        }, 800);
      }
